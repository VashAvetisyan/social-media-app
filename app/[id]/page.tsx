				...
				<div className='flex-grow max-w-2xl border-x border-gray-100'>
					...
					<div className='flex flex-col p-3 space-y-5 border-b border-gray-100'>
						<div className='flex justify-between items-center mb-1.5'>
							<div className='flex space-x-3'>
								<Image src={"/assets/profile.png"} width={44} height={44} alt="Profile" className='w-11 h-11' />
								<div className='flex flex-col text-[15px]'>
									<span className='font-bold inline-block whitespace-nowrap overflow-hidden text-ellipsis max-w-[60px] min-[400px]:max-w-[100px] min-[500px]:max-w-[140px] sm:max-w-[160px]'>{post?.name}</span>
									<span className='text-[#707E89] inline-block whitespace-nowrap overflow-hidden text-ellipsis max-w-[60px] min-[400px]:max-w-[100px] min-[500px]:max-w-[140px] sm:max-w-[160px]'>{post?.username}</span>
								</div>
							</div>
					...
					<div className='border-b border-gray-100 p-3 text-[15px]'>
						<span className='font-bold'>
							{post?.likes.length} Lliks
						</span>
					</div>

					<div className='border-b border-gray-100 text-[15px] flex justify-evenly p-3'>
